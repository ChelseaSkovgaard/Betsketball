...
class App extends Component {
  ...
  updateWagers() {
    ...
    for (var i = 0; i < wagersDates.length; i++){
      ...
      // TODO: mark when wagers are completed / assessed
    }
  }
  checkOutcome() {
    ...
    for (var i = 0; i < finishedWagers.length; i++) {
      ...
      if (outcome === finishedWagers[i].wager.outcome){
        // GET USER BUDGET
        // let userUID = finishedWagers[i].user.uid
        // let userBudget = this.state.budgets[userUID]
        // let amount = finishedWagers[i].wager.amount
        // let newBudget =  userBudget - amount
        // let ref = newBudget;
